...
ok('0. tres faixas: 1,50 / 8 / 12', EXCEDENTE_FAIXAS.length === 3
   && EXCEDENTE_FAIXAS[0].ate === 1.5 && EXCEDENTE_FAIXAS[1].ate === 8 && EXCEDENTE_FAIXAS[2].ate === 12,
   EXCEDENTE_FAIXAS);
...
console.log('\n-- faixa 2: de 1,50 a 8 m -> 15 cm --');
[['1.51', 15], ['2.94', 15], ['4.5493', 15], ['6.50', 15], ['7.99', 15]].forEach(([e, s]) =>
  ok(`2. ${e} m -> ${s} cm`, exc(e) === s, exc(e)));

console.log('\n-- faixa 3: de 8 a 12 m -> 20 cm --');
[['8.01', 20], ['9', 20], ['11.99', 20], ['12', 20]].forEach(([e, s]) =>
...
ok('4c. 8 exato -> 15 cm (nao 20)', exc('8') === 15, exc('8'));
ok('4d. 8.00 -> 15 cm', exc('8.00') === 15, exc('8.00'));
...
ok('6e. com espaco em volta', exc(' 9 ') === 20, exc(' 9 '));
